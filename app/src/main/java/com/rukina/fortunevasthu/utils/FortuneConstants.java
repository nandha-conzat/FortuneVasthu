...
public class FortuneConstants {
    ...
    public static final String USER_REGISTRATION_URL = BASE_URL + "api.php?func_name=eventRegister&reg_name=%s&reg_mobile=%s&reg_email=%s&reg_event_type=%s&reg_address=%s";
